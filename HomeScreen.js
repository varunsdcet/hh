    ...
    return(
     ...
     { this.state.is_rotated == 0 && (
      ...
      onPress={()=> this.setValue('Biceps')}>
         ...
         <View style = {{height:80,backgroundColor:'black',flexDirection:'row',width:'100%',justifyContent:'space-between',position:'absolute',top:5}}>



             <Text style = {{alignSelf:'center',textAlign:'center',color:'white',fontFamily:'Exo2-Bold',fontSize: 18,marginLeft:30,marginTop:20}}>
               Home
             </Text>
