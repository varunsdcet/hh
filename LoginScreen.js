...
console.log(responseJson)
 ...
 componentDidMount() {
  ...
  GoogleSignin.configure({
          ...
          webClientId: '112603521990-bg7vg614k3hb1k36jt5ahbtsa37q56ch.apps.googleusercontent.com',
        });
 }
    ...
    return(
      <View style={{flex:1,backgroundColor:'white'}}>
         ...
         <Button
           ...
           <Text style={{fontSize:42,fontFamily:'Exo2-Medium',color:'white',width:'65%',alignSelf:'center',textAlign:'center',marginTop:'10%'}}>Login to</Text>
